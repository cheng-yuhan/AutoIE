...
class HyperbandOracle(oracle_module.Oracle):
    ...
    def _get_size(self, bracket_num, round_num):
        ...
        bracket0_end_size = math.ceil(1 + math.log(self.max_trials, self.factor))
    ...
    def _get_epochs(self, bracket_num, round_num):
        return math.ceil(self.max_trials / self.factor ** (bracket_num - round_num))
